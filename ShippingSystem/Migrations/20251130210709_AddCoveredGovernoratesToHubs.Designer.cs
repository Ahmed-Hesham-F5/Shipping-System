...
namespace ShippingSystem.Migrations
{
    ...
    [Migration("20251130210709_AddCoveredGovernoratesToHubs")]
    partial class AddCoveredGovernoratesToHubs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShippingSystem.Models.DeliveryCoveredGovernorate", b =>
                {
                    ...
                    b.HasKey("HubId", "GovernorateId");

                    b.HasIndex("GovernorateId");

                    b.ToTable("DeliveryCoveredGovernorates", (string)null);
                });
            ...
            modelBuilder.Entity("ShippingSystem.Models.ExchangeRequestShipment", b =>
                {
                    ...
                    b.Property<string>("ExchangeDirection")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("ExchangeRequestId", "ShipmentId");

                    b.HasIndex("ShipmentId");

                    b.ToTable("ExchangeRequestShipments", (string)null);
                });
            ...
            modelBuilder.Entity("ShippingSystem.Models.PickupCoveredGovernorate", b =>
                {
                    b.Property<int>("HubId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("PickupCoveredGovernorates", (string)null);
                });
            ...
            modelBuilder.Entity("ShippingSystem.Models.ExchangeRequest", b =>
                {
                    b.HasBaseType("ShippingSystem.Models.RequestBase");
            ...
            modelBuilder.Entity("ShippingSystem.Models.DeliveryCoveredGovernorate", b =>
                {
                    ...
                    b.HasOne("ShippingSystem.Models.Hub", "Hub")
                        .WithMany("DeliveryCoveredGovernorates")
                        .HasForeignKey("HubId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ShippingSystem.Models.ExchangeRequestShipment", b =>
                {
                    b.HasOne("ShippingSystem.Models.ExchangeRequest", "ExchangeRequest")
                        .WithMany("ExchangeRequestShipments")
            ...
            modelBuilder.Entity("ShippingSystem.Models.PickupCoveredGovernorate", b =>
                {
                    ...
                    b.HasOne("ShippingSystem.Models.Hub", "Hub")
                        .WithMany("PickupCoveredGovernorates")
                        .HasForeignKey("HubId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ShippingSystem.Models.ExchangeRequest", b =>
                {
                    b.HasOne("ShippingSystem.Models.RequestBase", null)
                        .WithOne()
                        .HasForeignKey("ShippingSystem.Models.ExchangeRequest", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ShippingSystem.Models.Hub", b =>
                {
                    b.Navigation("DeliveryCoveredGovernorates");

                    b.Navigation("Employees");

                    b.Navigation("PickupCoveredGovernorates");
            ...
            modelBuilder.Entity("ShippingSystem.Models.ExchangeRequest", b =>
                {
                    b.Navigation("ExchangeRequestShipments");
                });
